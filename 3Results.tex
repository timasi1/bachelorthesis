...
\begin{figure}[thb]
    ...
    \caption{T2}
    \end{subfigure}
    \caption{The magnetic order of the T1 and T2 phases of \ce{Mn3Pt} with the illustrated conserved time-reversal mirror plane $\mathcal{TM}_i$ or mirror plane $\mathcal{M}_i$, respectively, and the reflection symmetry planes $\sigma_{v,i}$, belonging to the $[C_{2\hat{s}}||\sigma_v]$ operation, depicted on the corresponding kagome lattice. The T1 order has time-reversal mirror planes whereas the T2 phase has mirror planes.}
...
Thus, the Berry curvature vanishes in the absence of SOC in the nonbreathing limit. We also observe, that the Berry curvature vanishes in the presence of SOC in the nonbreathing limit. Although this result would be consistent with an additional $\mathcal{TM}$ symmetry in $xz$-plane, which would hold in the nonbreathing limit, such a symmetry has not been established for the full Hamiltonian. Therefore, a future sturdy would have to show this. Hence, we treat this as a numerical observation. Nevertheless, with no regard to the additional symmetry plane, the Chern number is forced to zero due to the conserved $\mathcal{M}$ symmetry.
\begin{figure}[tbhp]
    \centering
    \includegraphics[
        width=\linewidth
...
The alternating form of the Berry curvature for a breathing lattice comes from the combination of $C_{3z}^s$ and the mirror plane $\mathcal{M}$. An odd behavior of the Berry curvature is not expected in the presence of SOC, and can be checked numerically, yielding
\begin{align}
...
\end{align}
In absence of SOC for the breathing case, the energy and in-plane spins are as expected even, whereas the Berry curvature is odd.
\newpage
...
The magnetic moments form a triangular $120^\circ$ order and therefore the structures depicted in Figs.~\ref{fig: magnetic texture Mn3Ge and Sn}~(a) and (b) follow from the magnetic point groups $m'mm'$ and $mm'm'$, respectively.\\
...
In the magnetic texture, the symmetry $[C_{3z}||C_{3z}^{-1}]$ is found, which combines a $120^\circ$ spin-space rotation and a $-120^\circ$ spatial rotation. This symmetry stems from the magnetic order, depicted in Fig.~\ref{fig: magnetic texture Mn3Ge and Sn}, which can be shown by proving
\begin{align}
...
The conservation of the $\mathcal{TM}$ plane has to be proven again in the presence of SOC according to Eq.~\eqref{eq: TM symmetry prove eq}.
The mirror plane $\mathcal{M}$, which is in this case equal to $[C_{2\hat{s}}||\sigma_v]$ because the spin is perpendicular to the mirror plane, is expected to hold in the presence of SOC, due to $[C_{2\hat{s}}||\sigma_v]$ transforming spin-space and real-space equivalently.

In contrast, the $[C_{2\hat{\mathbf{s}}}||\sigma_v]$ operator, whose plane is depicted in Fig.~\ref{fig: magnetic texture Mn3Ge and Sn}, is broken by SOC in \ce{Mn3Ge} in the presence of SOC because the spin on the mirror plane is in the mirror plane and, therefore, the spin-space and spatial transformations are inequivalent.   \\
...
The properties imposed by $[C_{2\hat{s}}||\sigma_v]$ can also be observed in the absence of SOC. However, we also are able to observe properties imposed by the $\mathcal{TM}$ plane, according to Eq.~\eqref{eq: symmetry_TM}, in the case of SOC, therefore, we expect that this symmetry also holds for SOC. This has to be shown, as earlier stated. \\
...
In the presence of SOC in the breathing lattice, $\Theta_s [C_{2z}||E]$, $[C_{2\hat{s}}||\sigma_v]$ and $[C_{3z}||C_{3z}^{-1}]$ are broken. The only observable symmetry is the $\mathcal{TM}$ symmetry, which provides another reason for the assumed conservation for SOC for the $\mathcal{TM}$ plane. !!!!!!!!!!!!!!!!!!!!!\\
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
Hence, a magnetization along a direction deforms the Fermi surface perpendicular to the polarization of the magnetization accordingly.


Figs.~\ref{fig:Mn3Ge-nonbreathing} and \ref{fig:Mn3Ge-breathing} show that the bands are spin-split also in the absence of SOC, classifying \ce{Mn3Ge} as a strong altermagnet. The spin-splitting arises because the compensated texture breaks $\mathcal{PT}$ symmetry and other symmetries enforce band degeneracies.
...
Note that none of the constraints imposed by the symmetry $[C_{3z}||C^{-1}_{3z}]$ according to Eq.~\eqref{eq: C_3z^-1 symm} can be observed in the presence of SOC, hence verifying that the found $[C_{3z}||C_{3z}^{-1}]$ symmetry breaks in the presence of SOC. 
\begin{figure}[htbp]
    \centering
    \includegraphics[
        width=\linewidth
...
The magnetic order is fully compensated due to the three equal-magnitude moments separated by $120^\circ$ summing to zero, as depicted in Fig.~\ref{fig: magnetic texture Mn3Ge and Sn}~(b). 
