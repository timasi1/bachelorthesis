...
The T1 and T2 phase of \ce{Mn3Pt}, as well \ce{Mn3Ge} and \ce{Mn3Sn}, give equivalent results in the absence of spin-orbit coupling (SOC) because their magnetic order differ by a global spin rotation.\\
In \ce{Mn3Ge} and \ce{Mn3Sn} we find a symmetry, imposing $C_{3z}$-symmetric behavior in absence of SOC, where the spin-space is rotated inversely. In \ce{Mn3Pt} we find a similar behavior, however, now holding also for SOC.\\
The numerical computations show behavior, imposed by $\mathcal{TM}$ planes, for the T1 phase of \ce{Mn3Pt} and \ce{Mn3Ge} and by $\mathcal{M}$ planes, for the T2 phase of \ce{Mn3Pt} and \ce{Mn3Sn}.\\
